...
export const DEV_LOG_ENTRIES = [
  {
    ...
    body: 'Mentavio now has the public launch layer needed before a wider release. Players can join the early access list, invite friends, read product updates, and share achievements or portfolio results.',
